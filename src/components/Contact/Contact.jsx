  ...
  return (
    <>
      ...
      >
        ...
        <HStack height={'30%'} width={'80%'} >
          <HStack height={'100%'} width={'100%'} margin={'auto'}>
          <VStack width={"20%"} margin={'auto'}>
            <VStack width={'50px'} height={'50px'} borderRadius={'50%'} background={'orange'} display={'flex'} justifyContent={'center'} alignItems={'center'} flexDir={'columnn'} >
              <BiCurrentLocation fontSize={'30px'} color='white' />
            </VStack>
            <Text textAlign={'center'}><b>Address</b><br/>Punjab, India</Text>
          </VStack>
          <VStack width={"20%"} margin={'auto'}>
            <VStack width={'50px'} height={'50px'} borderRadius={'50%'} background={'orange'} display={'flex'} justifyContent={'center'} alignItems={'center'} flexDir={'columnn'} >
              <BiPhone fontSize={'30px'} color='white' />
            </VStack>
            <Text textAlign={'center'}><b>Phone</b><br/> +91 6377535991</Text>
          </VStack>
          <VStack width={"20%"} margin={'auto'}>
            <VStack width={'50px'} height={'50px'} borderRadius={'50%'} background={'orange'} display={'flex'} justifyContent={'center'} alignItems={'center'} flexDir={'columnn'} >
              <AiOutlineMail fontSize={'30px'} color='white' />
            </VStack>
            <Text textAlign={'center'}><b>Email</b> <br/><Link>sharma.karan27oct@gmail.com</Link></Text>
          </VStack>
          <VStack width={"20%"} margin={'auto'}>
            <VStack width={'50px'} height={'50px'} borderRadius={'50%'} background={'orange'} display={'flex'} justifyContent={'center'} alignItems={'center'} flexDir={'columnn'} >
              <BiGlobe fontSize={'30px'} color='white' />
            </VStack>
            <Text textAlign={'center'}><b>Website</b><br/><Link>sharma.karan27oct@gmail.com</Link></Text>
          </VStack>
